...
class PersonTest{
	...
	public boolean equals(Object obj) {
		if (this == obj) // 동일한 객체인지
			return true;
		if (obj == null) // 객체 != null			 값이 없으면 false
			return false;
		if (this.getClass() != obj.getClass()) // 타입이 같은지
			return false; // 메소드가 return 되면 종료된다.
...
public class L02Equals {
	public static void main(String[] args) {
		PersonTest 최경민 = new PersonTest("최경민", 37);
		PersonTest 최경민2 = new PersonTest("최경민", 37);
		System.out.println(최경민 == 최경민2);
		System.out.println(최경민.equals(최경민2)); //
	}
}
