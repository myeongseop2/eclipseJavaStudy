...
public class L12Lambda {
	public static void main(String[] args) {
		// JavaScript(함수형언어, 프로토타입언어) 람다식 : function() {} 함수 => 프로토 타입(타입), class (문법적 설탕 == function), () => {} 람다식 함수 (타입이 존재하지 않는)
		...
		Consumer<Integer> squarPrint=(i)->{System.out.println(i*1);};
		squarPrint.accept(123);
